...
public:
  ...
  view2D(view2D<T> const & rhs) = delete; // copy constructor
  ...
  view2D& operator= (view2D<T> const & rhs) = delete; // move assignment
...
public:
  ...
  view3D(view3D<T> const & rhs) = delete; // copy constructor
  ...
  view3D& operator= (view3D<T> const & rhs) = delete; // move assignment
...
public:
  ...
  view4D(view4D<T> const & rhs) = delete; // copy constructor
  ...
  view4D& operator= (view4D<T> const & rhs) = delete; // move assignment
...
#ifdef  NO_UNIT_TESTS
  inline status_t all_tests(int const echo=0) { std::printf("\nError: %s was compiled with -D NO_UNIT_TESTS\n\n", __FILE__); return -1; }
#else // NO_UNIT_TESTS
